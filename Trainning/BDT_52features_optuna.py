...
best_params = {
    ...
    'eval_metric': ['logloss', 'auc'],
     'max_depth': 7, 
     'eta': 0.07173357642781726, 
     'subsample': 0.8989225914070433,
    'colsample_bytree': 0.8562934881658744, 
    'lambda': 2.276738882609824, 
    'alpha': 9.417996186958515, 
    'min_child_weight': 67, 
    'gamma': 0.011206199947849516,
    'n_jobs': -1
}
